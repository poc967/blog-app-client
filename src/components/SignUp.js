...
class SignUp extends Component {
  ...
  handleSubmit = (e) => {
    ...
    if (
      ...
      !confirmPassword(password, this.state.confirmPassword)
    ) {
      return;
    }
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <FormGroup>
              ...
              <Input
                ...
                placeholder="supersecret"
                valid={
                  this.state.confirmPassword ? passwordsMatch : !passwordsMatch
                }
            ...
            <ModalFooter>
              <Button onClick={this.handleSubmit} color="primary" block>
                Get Started!
              </Button>
            </ModalFooter>
          </Form>
